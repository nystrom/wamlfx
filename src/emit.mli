...
sig
  ...
  include module type of Wasm.Values
...
(* val emit_type : 'a ctxt -> W.region -> sub_type -> int32 *)
(* val emit_type_deferred : 'a ctxt -> W.region -> int32 * (sub_type -> unit) *)
